...
docker network inspect otlp-testing-api_lgtm-network
```
...
docker volume rm otlp-testing-api_tempo-data
docker volume rm otlp-testing-api_loki-data
docker volume rm otlp-testing-api_prometheus-data
docker volume rm otlp-testing-api_grafana-data
```
